        ...
        <>
            <div className="custom-main-footer container">
                <footer className="pt-5 pb-3">
                        ...
                        <div className="col-4 ">
                            <h5>About Us</h5>
                            <p className=' p-0'>Using our web-based app, we engage volunteers to transfer fresh food surpluses from local businesses to social service agencies serving the food insecure.</p>
                        </div>

                       

                    <div className="d-flex justify-content-between border-top- pr-5 mt-3">
                        <p>&copy; 2024 Share and Care. All rights reserved.</p>
